...
public class MecSignInAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv.setOnClickListener(v -> startActivity(new Intent(this, MecSignUpAct.class)));
    }
    ...
    private void signIn(Map<String, String> pms) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, URLs.MEC_LOGIN, response -> {
            ad.dismiss();
