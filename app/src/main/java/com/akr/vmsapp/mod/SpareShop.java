...
public class SpareShop {
    private String spsId, name, countryCode, POBox, box, zipCode, locDesc, town, tel1, tel2, tel3,
            email1, email2, faxNumber, photoUrl, lat, lng, locName, status, addDate;

    public SpareShop() {
    }

    public SpareShop(String spsId, String name, String countryCode, String POBox, String box, String zipCode,
