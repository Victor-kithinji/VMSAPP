...
public class GrgRatingsAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_grg_ratings);
        setTitle("Garage rating");

        data = new ArrayList<>();
        lvData = findViewById(R.id.lv_grg_ratings);
    ...
    private void getGrgRatings() {
        AlertDialog ad = new AlertDialog.Builder(this).setView(R.layout.progress).setCancelable(false).create();
        ad.show();

        StringRequest request = new StringRequest(Request.Method.POST, URLs.GET_GRG_RATINGS, response -> {
            ad.dismiss();
                    ...
                    if (dc > 0) {
                        ...
                        for (int i = 0; i < dc; i++) {
                            ...
                            data.add(new Rating(
                                    ...
                                    usr.getString("garageId"), Float.parseFloat(usr.getString("stars")),
