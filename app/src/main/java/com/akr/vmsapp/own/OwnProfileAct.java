...
public class OwnProfileAct extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.act_own_profile);
        setTitle("Owner Profile");

        Owner usr = PrefManager.getInstance(this).getOwner();
        ...
        //tv11.setText(DateFormat.getDateInstance(DateFormat.FULL).format(usr.getRegDate()));
