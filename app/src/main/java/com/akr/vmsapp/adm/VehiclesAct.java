...
import com.akr.vmsapp.ada.VehiclesAdapter;
...
public class VehiclesAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_rv_gen);
        setTitle("Vehicles");
    ...
    private void buildRecycler() {
        ...
        mAdapter = new VehiclesAdapter(data, this);
                    ...
                    if (dc > 0) {
                        ...
                        for (int i = 0; i < dc; i++) {
                            ...
                            data.add(new Vehicle(
                                    usr.getString("vehicleId"), usr.getString("ownerId"),
                                    usr.getString("numberPlate"), usr.getString("modelId"),
                                    usr.getString("typeId"), usr.getString("weight"),
                                    usr.getString("color"), usr.getString("sector"),
                        ...
                        tvNoData.setText("Sorry! No vehicles available. Please contact System Admin to add some");
                    }
                } else {
