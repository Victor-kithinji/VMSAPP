...
public class AddVehicleTypeAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_add_vehicle_type);
    ...
    private void submit(Map<String, String> pms) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, URLs.ADD_VEHICLE_TYPE, response -> {
            ad.dismiss();
